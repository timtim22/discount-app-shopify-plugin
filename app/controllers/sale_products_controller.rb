class SaleProductsController < ShopifyApp::AuthenticatedController
  ...
  def create
    ...
    respond_to do |format|
      if @sale_product.save
        format.html { redirect_to @sale_product.sale, notice: 'Sale product was successfully added.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to sale, notice: 'Sale product was successfully removed.' }
  ...
  private
    ...
    def sale_product_params
      params.require(:sale_product).permit(:sale_id, :product_id)
    end
end
